...
class TrueUSD extends Component {
    ...
    copy() {
        var copyText = document.getElementById('addressInputTUSD');
        copyText.select();
        var address = this.state.address;
        this.setState({copied: document.execCommand("copy"), address: "Your TUSD address copied"});
        setTimeout(() => {
    ...
    transfer(e) {
        ...
        if (receiverAmount == "" || receiverAddress == "") {
            ...
            auth.fetch('trueusd/send', {
                method: "POST",
                body: JSON.stringify({
                    id: this.state.user.wallet.trueusd,
                ...
                if (res.success == true) {
                    ...
                    this.setState({send: 'false', loading: false, error: res.error.message})
                }
            })
        }
    }
    ...
    render() {
        ...
        return (
            <div className="animated fadeInno-pm">
                {
                ...
                }
                {
                    this.state.send == 'false' ?
                        <SweetAlert title="Error!" onConfirm={this.hideAlert}>Error occured in Transacting
                            <br></br> {this.state.error}            </SweetAlert>
                        : null
                }
                {
                ...
                <div className="wallet-row">
                    <Col xs="12" className="table-row">
                        <Col md="2" sm="6" xs="6" className="h-100 no-p">
                            <div className="flex-container pl-3">
                                <div className="d-inline-block">
                                    <img className="coin-icon" src="/assets/tusdicon.png"/> TUSD (TrueUSD)
                                </div>
                            </div>
                        </Col>
                        ...
                        <Col md="1" className="hidden-xs h-100 no-p">
                            <div className="flex-container pl-3">
                                {parseFloat(this.state.balance).toFixed(5)}
                            </div>
                        </Col>
                        ...
                        <Col md="5" className="hidden-xs h-100 no-p">
                            <div className="flex-container pl-2">
                                <div className="d-inline-block w-100">
                                    <input readOnly id="addressInputTUSD" name="addressInputTUSD" onChange={this.changeUpdate}
                        ...
                        <Col md="1" className="h-100 no-p">
                            <div className="flex-container p-1">
                                ...
                                {
                                    !this.state.collapse &&
                                    <ThemeButton buttonText="Send TUSD" buttonSize="small" onClick={this.toggle}/>
                                }
                            </div>
                        </Col>
                    </Col>
                    <Collapse isOpen={this.state.collapse}>
                        <Col xs="12" className="collapse-container">
                            <div className="theme-text-h3 mt-5">
                                ...
                                style={{fontWeight: "600", verticalAlign: "middle"}}>TUSD </span><img
                                style={{width: "25px"}} src="/assets/tusdicon.png"/>
                            </div>
